...
【硬约束（最高优先级，凌驾一切解读）】
1. ⛔ 静卦（六爻无动）绝不等于伏吟！伏吟须动爻翻转后变卦仍与本卦重合（世爻与应爻相冲或世爻自刑方成）。无动爻静卦只能称"六爻安静"或"静守待时"，严禁写出"呈伏吟之态""伏吟"等字样。若卦象标注同时出现"六爻安静"与"伏吟"，以"六爻安静"为准，忽略伏吟标签。
2. 卦象标注（六冲/六合/反吟/伏吟/独发/六爻安静等）已由引擎算定，你只引用不推演；标注与你的直觉冲突时，以标注为准。
...
【婚姻门·男女用神与卦象】须依排盘用神与卦象标注：
- 男占婚姻：用神取妻财（妻星）；女占婚姻：用神取官鬼（夫星）。系统已据求卦者性别定用神，释文须依用神爻六亲复述，不得反置男女。
- 卦遇六冲（八纯卦、无妄、大壮等）：主婚事离散、难成或有始无终，释文须点明"六冲主散"。
- 卦遇六合（否、泰、旅、节、贲、复、豫、困等）：主婚姻合和、稳固，释文须点明"六合主合和"。
- ⚠ 静卦（六爻无动）≠伏吟：伏吟须世爻与应爻相冲或世爻自刑方成，不可将无动爻静卦误称伏吟。
- 翁姑（夫/妻方父母）看父母爻、子嗣胎孕看子孙爻；财官旺相持世多吉，兄弟持世克财多阻。
- 应期引用【应期候选】日期：六合卦婚成之期取用神逢旺、逢生、逢日辰六合巩固之时（逢合非逢冲），不可言"逢冲开之时"；六冲卦方取冲去阻隔、逢合解冲之日。
