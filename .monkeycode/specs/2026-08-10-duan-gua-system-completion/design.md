...
```jsonc
{
  ...
  "yaoDetail": [
    {
      "shengWangMuJue": { "changShengZhi": "申", "ruMu": false, "linJue": false, "state": "" },
...
- 六冲六合标注：八纯卦、天雷无妄、雷天大壮为六冲；天地否、地天泰、水泽节、火山旅、雷地豫、山火贲、泽水困、地雷复为六合（64 卦程序扫描结果，与《增删卜易·六合章》列举一致）——回归脚本断言全表
- 长生墓绝：`CHANG_SHENG_TABLE` 定五行长生起始支（金巳、木亥、水土申、火寅）；入墓/临绝按**月支或日支是否为该爻五行之墓库/绝位**判定（金墓丑、木墓未、水土墓辰、火墓戌；金绝寅、木绝申、水土绝巳、火绝亥），与《增删卜易·生旺墓绝章》墓位一致
